...
## Website Screenshot
![The Horiseon webpage includes a navigation bar, a header image, and cards with text and images at the bottom of the page.](./assets/images/webpage-image.png)

## Link to Deployed Application
[Deployed Application](https://cstuhlfire.github.io/homework1-code-refactor/)
## Link to Gitbub
[Link to Github Repository](https://github.com/cstuhlfire/homework1-code-refactor)

```
## Original 01 HTML, CSS, and Git: Code Refactor Assignment
